  ...
  return (
    <div className='bordes separacion faq'>
      ...
      <div className='faq__list'>
        <ul>
          <li>¿De dónde son?</li>
          <p>Somos originarios de CDMX, México pero hacemos pedidos a toda la república.</p>
          ...
          <p>Si hacemos gorras con diseños personalizados, puedes comprar la gorra aquí, escoges el color que gustes y nos mandas tu diseño/frase junto con tu número de pedido por inbox a nuestra página de Facebook o Instagram para darle seguimiento. También puedes enviarlo a info@mediamostaza.com.</p>
          ...
          <p>Envíanos un correo a info@mediamostaza.com con todos tus datos para proceder con la factura. Es importante que nos envíes esto el mismo mes de tu compra. </p>
        </ul>
      </div>
    </div>
  )
